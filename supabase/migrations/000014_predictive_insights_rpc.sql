-- ============================================================
-- 000014_predictive_insights_rpc.sql
-- Family Finance — Add Predictive Insights to Dashboard RPC
-- ============================================================
...
BEGIN
    ...
    IF v_upcoming_expenses > 0 THEN
        ...
        ELSE
            -- Include positive reinforcement if they have upcoming bills but enough cash
            v_insights := v_insights || jsonb_build_array(
