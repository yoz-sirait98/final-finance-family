...
## Corpus Check
- 110 files · ~93,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1143 nodes · 1587 edges · 131 communities (95 shown, 36 thin omitted)
...
Cohesion: 0.09
Nodes (22): ai, subtitle, title, welcome, auth, categories, addCategory, color (+14 more)
...
Cohesion: 0.13
Nodes (26): add, header, description, title, add, header, add, header (+18 more)
...
Cohesion: 0.70
Nodes (4): cleanLineOfDatesAndTimes(), extractNumbers(), parseDate(), scanReceipt()
...
Cohesion: 0.07
Nodes (43): balance, description, title, description, title, expense, income, transfer (+35 more)
...
- **Why does `dashboard` connect `Virtual Scroll Component` to `Time Intervals`, `Database Backup Script`, `Community 105`, `Community 107`, `Dashboard Analytics Metrics`, `Community 124`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `common` connect `Common UI Actions` to `Family Member Roles`, `Community 106`, `Transactions Page View`, `Community 46`, `Community 110`, `Budget Limits and Alerts`, `Community 126`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `dashboard` connect `Community 110` to `Navigation and Management`, `Dashboard Analytics Metrics`, `Family Member Roles`, `Budget Limits and Alerts`?**
