...
## Corpus Check
- 106 files · ~88,365 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1108 nodes · 1551 edges · 129 communities (93 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca346862`
...
Cohesion: 0.16
Nodes (18): balance, description, title, alerts, expense, income, transfer, insights (+10 more)
...
Cohesion: 0.25
Nodes (8): reports, endDate, exportCsv, exportPdf, generating, startDate, subtitle, title
...
Cohesion: 0.18
Nodes (19): add, list, description, title, add, list, add, list (+11 more)
...
Cohesion: 0.25
Nodes (14): balance, expense, income, transfer, net, description, title, add (+6 more)
...
Cohesion: 0.15
Nodes (14): ai, subtitle, title, welcome, auth, categories, addCategory, color (+6 more)
...
## Knowledge Gaps
- **631 isolated node(s):** `recommendations`, `name`, `private`, `version`, `type` (+626 more)
...
- **Why does `dashboard` connect `Virtual Scroll Component` to `Time Intervals`, `Community 131`, `Database Backup Script`, `Community 107`, `Dashboard Analytics Metrics`, `Community 124`, `Community 127`?**
