...
## Corpus Check
- 106 files · ~87,627 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1101 nodes · 1544 edges · 133 communities (97 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3eaaef48`
...
Cohesion: 0.05
Nodes (37): nav, accounts, aiadvisor, analytics, brand, budgetAlerts, budgets, categories (+29 more)

### Community 10 - "Account and Recurring Management"
Cohesion: 0.09
Nodes (27): login, register, createAccount, email, emailPlaceholder, failed, newHere, password (+19 more)
...
Cohesion: 0.14
Nodes (22): add, list, description, title, add, list, list, description (+14 more)
...
## Knowledge Gaps
- **626 isolated node(s):** `recommendations`, `name`, `private`, `version`, `type` (+621 more)
...
- **Why does `dashboard` connect `Community 111` to `Family Member Roles`, `Family Member Roles`, `Navigation and Management`, `Month Labels`, `Dashboard Analytics Metrics`, `Community 121`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `dashboard` connect `Virtual Scroll Component` to `Time Intervals`, `Community 130`, `Community 131`, `Database Backup Script`, `Community 107`, `Dashboard Analytics Metrics`, `Community 124`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `common` connect `Common UI Actions` to `Community 105`, `Community 106`, `Community 46`, `Month Labels`, `Community 121`, `Community 126`?**
