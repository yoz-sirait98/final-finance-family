# Graph Report - redesign-ui-supabase-stack  (2026-06-10)

## Corpus Check
- 105 files · ~87,226 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1090 nodes · 1534 edges · 129 communities (93 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc3873fd`
...
Cohesion: 0.09
Nodes (31): useDashboard(), initializeRealtime(), supabase, router, routes, accountService, aiService, authService (+23 more)
...
Cohesion: 0.10
Nodes (21): nav, accounts, aiadvisor, analytics, brand, budgetAlerts, budgets, categories (+13 more)
...
Cohesion: 0.10
Nodes (31): balance, description, title, expense, income, transfer, dashboard, charts (+23 more)

### Community 15 - "Financial Data Export"
Cohesion: 0.15
Nodes (12): ai, subtitle, title, welcome, auth, categories, addCategory, color (+4 more)
...
Cohesion: 0.11
Nodes (27): balance, expense, income, transfer, dashboard, expenseByCategory, expenseTrend, incomeVsExpense (+19 more)
...
Cohesion: 0.29
Nodes (7): 1. Migrated System Architecture, 2. Feature Inventory, 3. Business Rules Inventory, 4. Dependencies Inventory, 5. Risks, 6. Migration Complexity Assessment, Phase 1 â€” Project Discovery Report
...
Cohesion: 0.19
Nodes (15): list, description, title, alerts, list, list, description, title (+7 more)
...
Cohesion: 0.14
Nodes (16): description, title, description, title, reports, endDate, export, exportCsv (+8 more)
...
Cohesion: 0.09
Nodes (22): ai, subtitle, title, welcome, auth, subtitle, members, addMember (+14 more)

### Community 39 - "Database Backup Script"
Cohesion: 0.29
Nodes (7): description, title, transactions, table, transfer, description, title

### Community 40 - "UI Assets and Icons"
Cohesion: 0.22
Nodes (8): Family Finance Migration & Integration Tasks, Part 1 — Supabase Migration Tasks, Part 2 — Indonesian Language Mode Tasks, Part 3 — Reports Page Filtering Fix, Part 4 — AI Assistant Graphify Integration, Part 5 — Modular Agent Rules and Knowledge Reorganization, Part 6 — Offline OCR Receipt Scanner & AI Financial Coach, Part 7 — Cross-Device Gemini API Key Syncing
...
Cohesion: 0.25
Nodes (8): Automated Tests, Frontend Services & Stores, Manual Verification, Part 7 — Cross-Device Gemini API Key Syncing (Proposed), Proposed Changes, Supabase Database Migration, User Review Required, Verification Plan

### Community 43 - "Members Page View"
Cohesion: 0.83
Nodes (3): extractNumbers(), parseDate(), scanReceipt()
...
Cohesion: 0.17
Nodes (9): description, title, balance, expense, income, description, title, description (+1 more)
...
Cohesion: 0.33
Nodes (5): Family Finance Architecture & Integration Plans, Part 1 â€” Family Finance Architecture Migration: Laravel to Supabase (Completed), Part 3 — Collaborative Shopping & Shared Bills, Phase 2 â€” Migration Task Breakdown, Phase 4 â€” Post-Migration Polish (Completed)
...
## Knowledge Gaps
- **620 isolated node(s):** `recommendations`, `name`, `private`, `version`, `type` (+615 more)
...
- **Why does `dashboard` connect `Month Labels` to `Navigation and Management`, `Dashboard Analytics Metrics`, `Family Member Roles`, `Financial Data Export`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `dashboard` connect `Virtual Scroll Component` to `Time Intervals`, `Currency Formatting Utilities`, `Dashboard Analytics Metrics`, `Community 124`, `Report Generation and Export`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `common` connect `Common UI Actions` to `Community 105`, `Community 106`, `Community 46`, `Month Labels`, `Financial Data Export`, `Community 112`, `Community 126`?**
