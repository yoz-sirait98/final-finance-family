# Graph Report - final-finance-family  (2026-07-24)

## Corpus Check
- 157 files · ~113,761 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1496 nodes · 2227 edges · 157 communities (115 shown, 42 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df6eff27`
...
Cohesion: 0.07
Nodes (35): useDashboard(), initializeRealtime(), supabase, router, routes, accountService, aiService, authService (+27 more)
...
Cohesion: 0.10
Nodes (18): useTour(), chatHistory, hasApiKey, loading, localeStore, messagesContainer, router, scrollToBottom() (+10 more)
...
Cohesion: 0.08
Nodes (29): done, next, prev, description, title, description, title, description (+21 more)
...
Cohesion: 0.22
Nodes (10): loadOpenCV(), fileToImageElement(), preprocessReceiptImage(), categoryKeywords, classifyConfidence(), extractRightmostAmount(), fuzzyMonths, parseDate() (+2 more)
...
## Knowledge Gaps
- **700 isolated node(s):** `Overview`, `1. Database Schema (`supabase/migrations/000029_push_subscriptions.sql`)`, `2. Custom PWA Service Worker (`src/sw.js` & `vite.config.js`)`, `3. Subscription & Auto-Locale Sync Service (`src/services/pushNotificationService.js`)`, `4. Multi-Language Push Dispatcher (`src/services/pushDispatcherService.js`)` (+695 more)
...
- **Why does `tours` connect `Report Generation and Export` to `Supabase Project Metadata`, `Community 128`, `Community 130`, `Community 131`, `Family Member Roles`, `Authentication Forms`, `Database Backup Script`, `Budgets Page View`, `Community 110`, `Community 78`, `Community 114`, `Virtual Scroll Component`, `Savings Goals Management`, `Community 155`, `Community 152`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `budgets` connect `Savings Goals Management` to `Time Intervals`, `Dashboard Layout Components`, `Account and Recurring Management`, `Community 110`, `Virtual Scroll Component`, `Report Generation and Export`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `dashboard` connect `Community 134` to `Community 132`, `Navigation and Management`, `Financial Data Export`, `Budget Tour Steps`, `Dashboard Analytics Metrics`, `Community 26`, `Supabase Skill Configuration`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **What connects `Overview`, `1. Database Schema (`supabase/migrations/000029_push_subscriptions.sql`)`, `2. Custom PWA Service Worker (`src/sw.js` & `vite.config.js`)` to the rest of the system?**
