...
## Corpus Check
- 156 files · ~114,570 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1538 nodes · 2290 edges · 169 communities (128 shown, 41 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e080f098`
...
Cohesion: 0.40
Nodes (4): [MODIFY] `frontend/src/pages/ShoppingDetailPage.vue`, Proposed Changes, Verification Plan, WhatsApp Checkout Notifications
...
Cohesion: 0.16
Nodes (20): balance, description, title, alerts, expense, income, transfer, net (+12 more)
...
Cohesion: 0.23
Nodes (11): loadOpenCV(), fileToImageElement(), preprocessReceiptImage(), categoryKeywords, classifyConfidence(), correctThermalDateTypo(), extractRightmostAmount(), fuzzyMonths (+3 more)
...
Cohesion: 0.17
Nodes (12): accounts, accountName, accountNamePlaceholder, addAccount, balancePlaceholder, editAccount, subtitle, title (+4 more)
...
Cohesion: 0.23
Nodes (12): add, description, title, add, add, add, add, accounts (+4 more)
...
Cohesion: 0.13
Nodes (22): add, description, title, add, description, title, add, add (+14 more)
...
Cohesion: 0.39
Nodes (6): cleanItemName(), extractPrice(), extractQuantity(), parseReceiptItems(), shouldSkipLine(), SKIP_KEYWORDS
...
## Knowledge Gaps
- **721 isolated node(s):** `recommendations`, `name`, `private`, `version`, `type` (+716 more)
...
- **Why does `tours` connect `Registration Page View` to `Community 26`, `Community 132`, `Community 134`, `Transaction and Budget Logic`, `Community 107`, `Reports Page View`, `Financial Data Export`, `Community 111`, `Community 113`, `Community 151`, `Savings Goals Management`, `Community 154`, `Supabase Skill Configuration`, `Community 156`, `Community 125`, `Social Media Icons`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `tours` connect `Community 128` to `Supabase Project Metadata`, `Community 130`, `Community 131`, `Family Member Roles`, `Authentication Forms`, `Community 167`, `Community 110`, `Community 78`, `Community 114`, `Community 152`, `Virtual Scroll Component`, `Savings Goals Management`, `Community 155`, `Report Generation and Export`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `common` connect `Common UI Actions` to `Registration Page View`, `Community 106`, `Community 150`, `Community 151`, `Community 120`, `Community 26`?**
